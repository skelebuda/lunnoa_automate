...
export class CreateTextPost extends Action {
  ...
  id() {
    return 'linkedin_action_create-text-post';
  }
  ...
  description() {
    return 'Create a text post on LinkedIn.';
  }
...
type ConfigValue = z.infer<ReturnType<CreateTextPost['aiSchema']>>;
