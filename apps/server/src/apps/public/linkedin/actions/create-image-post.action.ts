...
export class CreateImagePost extends Action {
  ...
  id() {
    return 'linkedin_action_create-image-post';
  }

  name() {
    return 'Create Image Post';
  }

  description() {
    return 'Create an image post on LinkedIn.';
  }
...
type ConfigValue = z.infer<ReturnType<CreateImagePost['aiSchema']>>;
