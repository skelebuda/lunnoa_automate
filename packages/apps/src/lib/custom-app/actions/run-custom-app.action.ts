...
export const runCustomApp = createAction({
  id: 'custom-app_action_run-custom-app',
  name: 'Run Custom App',
  description: 'Trigger one of your custom apps.',
  ...
  inputConfig: [
    createDynamicSelectInputField({
      ...
      label: 'Custom App',
      description:
        'Only manual and scheduled custom apps can be triggered by a workflow.',
      placeholder: 'Select a custom App',
      hideCustomTab: true,
      ...
      required: {
        missingMessage: 'Custom App is required',
    ...
    }),
    {
      ...
      description:
        'These are the custom fields configured in the custom app.',
      loadOptions: {
