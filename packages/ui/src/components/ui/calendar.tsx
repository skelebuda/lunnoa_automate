  ...
  return (
    <DayPicker
      ...
      components={{
        ...
        Dropdown: (props) => {
          const { fromYear, fromMonth, toDate, toYear } = useDayPicker();
          ...
          if (props.name === 'months') {
            ...
            return (
              ...
              >
                <Select.Trigger>{format(currentMonth, 'MMM')}</Select.Trigger>
                <Select.Content>
            ...
            return (
              <Select
                ...
                value={props.value?.toString()}
              >
                <Select.Trigger>{currentMonth.getFullYear()}</Select.Trigger>
                <Select.Content>
                  {selectItems.map((item) => (
                    <Select.Item key={item.value} value={item.value}>
                      {item.label}
