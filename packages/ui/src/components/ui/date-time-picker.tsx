        ...
        CaptionLabel: ({ displayMonth }) => {
          return (
            <div className="inline-flex gap-2">
              ...
              >
                <Select.Trigger className="w-fit border-none p-0 focus:bg-accent focus:text-accent-foreground">
                  <Select.Value />
                </Select.Trigger>
                <Select.Content>
                  {MONTHS.map((month) => (
              ...
              >
                ...
                <Select.Content>
                  {YEARS.map((year) => (
                    <Select.Item key={year.value} value={year.value.toString()}>
                      {year.label}
                    </Select.Item>
                  ))}
                </Select.Content>
    ...
    return (
      <Popover>
        ...
        <Popover.Content className="w-auto p-0">
          ...
          <div className="p-3 space-x-2 text-right">
