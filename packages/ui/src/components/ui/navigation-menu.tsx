...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Root
    ref={ref}
    className={cn(
      'relative flex max-w-max flex-1 items-center justify-center z-[1]',
      className,
    )}
    {...props}
  >
...
// const NavigationMenuLink = NavigationMenuPrimitive.Link; //Use react-router-dom Link iniside NavigationMenu.Item
...
export const NavigationMenu =
  NavigationMenuRoot as typeof NavigationMenuRoot & {
    ...
    // Link: typeof NavigationMenuLink; //Use react-router-dom Link iniside NavigationMenu.Item
