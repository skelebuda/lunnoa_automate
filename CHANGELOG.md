...
* knowledge service implementation of GCP storage ([c6e08a8](https://github.com/skelebuda/lunnoa_automate/commit/c6e08a87ead1efd692a285dbd88e671f4d53fe64))
...
# [1.196.0](https://github.com/skelebuda/lunnoa_automate/compare/v1.195.0...v1.196.0) (2025-07-07)
...
# [1.169.0](https://github.com/skelebuda/lunnoa_automate/compare/v1.168.0...v1.169.0) (2025-06-18)
...
# [1.158.0](https://github.com/skelebuda/lunnoa_automate/compare/v1.157.0...v1.158.0) (2025-06-18)
...
# [1.147.0](https://github.com/skelebuda/lunnoa_automate/compare/v1.146.0...v1.147.0) (2025-06-17)
...
# [1.21.0](https://github.com/skelebuda/lunnoa_automate/compare/v1.20.0...v1.21.0) (2025-03-25)
...
# [1.10.0](https://github.com/skelebuda/Lunnoa_Automate/compare/v1.9.0...v1.10.0) (2025-03-17)
...
* Add plugins to yml ([319b306](https://github.com/skelebuda/Lunnoa_Automate/commit/319b3061abdde6b1fe62cd8ac8f87e9abc83666d))
...
* **server:** Skip credit check if using custom llm connection for agent ([bfcc5d7](https://github.com/skelebuda/Lunnoa_Automate/commit/bfcc5d79074b18c83349f62d93690561d8d8ae2b))
...
* Use nx release publish ([ded6561](https://github.com/skelebuda/Lunnoa_Automate/commit/ded656103a557ea2f26716b9989aecc16236e369))
...
* **app:** Update lecca-io libs ([6bd35d5](https://github.com/skelebuda/Lunnoa_Automate/commit/6bd35d5c896ec38f9985bc3ec2746803d77b5661))
...
* **server:** Add DEV_EMAIL_DOMAIN server config item for dev module ([7538769](https://github.com/skelebuda/Lunnoa_Automate/commit/753876986fe65b47a39e5609a3cfe26c9268b61a))
* **server:** Add error handler to ai chat stream ([b87e01a](https://github.com/skelebuda/Lunnoa_Automate/commit/b87e01a6fd17bfa9b367313f44fe7a56a99f1807))
* **server:** Add error handling for missing NGROK_TUNNEL_URL in development ([82b99ce](https://github.com/skelebuda/Lunnoa_Automate/commit/82b99ce5460abcaf415a0e43b637dd8b0ab461bb))
* **server:** Add helpful error message for missing ai api keys ([537d0e4](https://github.com/skelebuda/Lunnoa_Automate/commit/537d0e4598281bac0f7175280ba336ec0d1eec07))
* **server:** Add new llm models, o1, o1-mini, flash-2.0-exp ([578a29a](https://github.com/skelebuda/Lunnoa_Automate/commit/578a29a2ed9327ef9a973d4121db28d368681ba5))
* **server:** Add provider endpoint to ai controller ([a99c5ca](https://github.com/skelebuda/Lunnoa_Automate/commit/a99c5cafafdce138b8c741a6215b55d02665dca9))
* **server:** Added tracking logic for commerical use ([3f67a63](https://github.com/skelebuda/Lunnoa_Automate/commit/3f67a63270b47e739a10f925b3fce99bb253f220))
* **server:** Convert all triggers to new format ([1bb1a7c](https://github.com/skelebuda/Lunnoa_Automate/commit/1bb1a7c5b3dfb3d7da2baa0236508fbb845250f0))
* **server:** Fetch ollama details using axios instead of using exec ([075c9af](https://github.com/skelebuda/Lunnoa_Automate/commit/075c9afde0419777dda08fcc7c23d217a173ce6f))
* **server:** Prevent execution and task deletion when billing disabled ([1329a67](https://github.com/skelebuda/Lunnoa_Automate/commit/1329a67513ff8de3f821d211d73e756b73af08c3))
* **server:** Remove needsConnection property from app constructor args ([aa776f7](https://github.com/skelebuda/Lunnoa_Automate/commit/aa776f767df2469df798be502c7fec6ac8624266))
* **server:** Remove s3 error log when deleting nothing ([18be80b](https://github.com/skelebuda/Lunnoa_Automate/commit/18be80b6a63891e6563cf330eb2e4eda2ba09ca8))
* **server:** Remove xml app to trigger release (testing) ([17a9020](https://github.com/skelebuda/Lunnoa_Automate/commit/17a902060fc88239e1c410fdae076620d358f3f2))
* **server:** Update trigger constructor to build from js object ([fbd8fd6](https://github.com/skelebuda/Lunnoa_Automate/commit/fbd8fd6f6cc64e95cb8ff30448195aff44436b70))
* Support apps, actions, and triggers from js object (WIP) ([3c1064a](https://github.com/skelebuda/Lunnoa_Automate/commit/3c1064a2d28f8a5d4dd0ed8bb6b5d98d873568ab))
* Task naming ([975b6b8](https://github.com/skelebuda/Lunnoa_Automate/commit/975b6b8573feba1b8df0857dcac344d2904878e6))
* Throttle auth routes ([cdc853d](https://github.com/skelebuda/Lunnoa_Automate/commit/cdc853d300f46d77785d4a6e7cad654322344a5d))
* **toolkit:** Create toolkit and apps packages (WIP) ([a5d3c65](https://github.com/skelebuda/Lunnoa_Automate/commit/a5d3c653d723db6cafd7692595331205065530fc))
* **ui:** Add ability to delete conversation ([4baedd0](https://github.com/skelebuda/Lunnoa_Automate/commit/4baedd092485044cfbb78333fe329df708c41ff3))
* **ui:** Add agent ui improvements ([7f8ecab](https://github.com/skelebuda/Lunnoa_Automate/commit/7f8ecab00f27970d96ec7297b1ee362b417c14de))
* **ui:** Add agents and recent executions to homepage ([9158046](https://github.com/skelebuda/Lunnoa_Automate/commit/915804626162318d8543a47d5b7342f81d3402b2))
* **ui:** Add conditional tracking using VITE_ENABLE_ANALYTICS env variable ([327d53b](https://github.com/skelebuda/Lunnoa_Automate/commit/327d53ba90234dfe645c1f5abbb0989c4c415e1f))
* **ui:** Add mobile ui popup to push users to use desktop ([ac3a03c](https://github.com/skelebuda/Lunnoa_Automate/commit/ac3a03cfd700a79ec1d84913a72194bf7206efe2))
* **ui:** Add toolIds and triggerIds expansion and properties to agent model ([251938c](https://github.com/skelebuda/Lunnoa_Automate/commit/251938ce29dfac1208e7018c61db253d63e0faf0))
* **ui:** Agent onboarding tour ([4cd4578](https://github.com/skelebuda/Lunnoa_Automate/commit/4cd4578b5b256eaddededc9a4d1a617edb9e39f2))
* **ui:** Disable auto scroll on chat ui if user scrolls up ([7de8426](https://github.com/skelebuda/Lunnoa_Automate/commit/7de8426964b0c82766511a4b51d9e3abe9066da4))
* **ui:** Hide google sign in if no google client id ([ea7b792](https://github.com/skelebuda/Lunnoa_Automate/commit/ea7b79285398e709b877a16db1ea54ba0007e2a2))
* **ui:** Hide templates carousel if there are no templates ([a832bdc](https://github.com/skelebuda/Lunnoa_Automate/commit/a832bdc6cb9999f47619a6787cd39e0af7df41a6))
* **ui:** Move agent to top over workflow ([d618c71](https://github.com/skelebuda/Lunnoa_Automate/commit/d618c7110c1af92784b23c1e8883cdf78c26ed69))
* **ui:** New side nav for agent UI ([089ec2a](https://github.com/skelebuda/Lunnoa_Automate/commit/089ec2aa564e6724685f4cc9db7a140d1a6389c7))
* **ui:** Parse chat error message improvements ([a0fa4a0](https://github.com/skelebuda/Lunnoa_Automate/commit/a0fa4a0c3cd71e88a4b20c2ee138c1c6f5c8432c))
* **ui:** Remove old logo and replace with credit card on left rail ([35bd59d](https://github.com/skelebuda/Lunnoa_Automate/commit/35bd59d7b42826746823b063decd77ce4819236e))
* **ui:** Update agent side nav and redirect home to agents page ([670adec](https://github.com/skelebuda/Lunnoa_Automate/commit/670adeca51ddf9214f1cacb7439933565e29d430))
* **ui:** Update agent side nav and redirect home to agents page ([fc63dec](https://github.com/skelebuda/Lunnoa_Automate/commit/fc63dec2c712e10dab1d94f36148a3e479d4c1cc))
* **ui:** Update favicon to use new logo ([347dc3e](https://github.com/skelebuda/Lunnoa_Automate/commit/347dc3ebb8358cfa9d659cd4a5d9b4f5d17ff33e))
* **ui:** Update favicons ([ba74ec7](https://github.com/skelebuda/Lunnoa_Automate/commit/ba74ec74cc5dead03fdc51dde4f1607d4d372e35))
* Update apps package ([a4abf52](https://github.com/skelebuda/Lunnoa_Automate/commit/a4abf524b9b335623a01d6e619d7a6e0d53977be))
* Update discord link ([1ffb132](https://github.com/skelebuda/Lunnoa_Automate/commit/1ffb13241a5e64457cd08bca775d1a0209e87d66))
* Update postgres_username env ([31abd00](https://github.com/skelebuda/Lunnoa_Automate/commit/31abd00cfa94df4756b4a0613aed29edc8c8a3cf))
